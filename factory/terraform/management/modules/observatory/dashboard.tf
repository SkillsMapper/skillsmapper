            ...
            "dataSets" : [
              {
                "timeSeriesQuery" : {
                  "timeSeriesFilter" : {
                    "filter" : "metric.type=\"run.googleapis.com/instance_counts/active\" resource.type=\"cloud_run_revision\" resource.label.\"service_name\"=\"${var.fact_service_name}\" metric.label.\"project_id\"=\"${var.monitored_project_id}\"",
                    "aggregation" : {
